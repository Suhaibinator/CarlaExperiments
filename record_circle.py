...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            #print(spawn_point)
            self.player = self.world.try_spawn_actor(blueprint, carla.Transform(carla.Location(x=238.4, y=50.1, z=0.82), carla.Rotation(pitch=0, yaw=-20, roll=0)))
        # Set up the sensors.
...
class KeyboardControl(object):
    ...
    def parse_events(self, client, world, clock):
        ...
        if not self._autopilot_enabled:
            if isinstance(self._control, carla.VehicleControl):
                ...
                #self._control.throttle = 1.0 if speed < 60 else 0.0
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        ...
        self._steer_cache =0#+= steer_increment
...
def game_loop(args):
    ...
    try:
        ...
        for i in range(100):
            ...
            pygame.display.flip()
            coords.append((world.player.get_location().x, world.player.get_location().y))
            #time.sleep(0.5)
...
def main():
    ...
    argparser.add_argument(
        '--filter',
        metavar='PATTERN',
        default='vehicle.dodge_charger.police',
